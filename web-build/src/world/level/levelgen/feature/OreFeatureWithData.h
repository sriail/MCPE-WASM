#ifndef NET_MINECRAFT_WORLD_LEVEL_LEVELGEN_FEATURE__OreFeatureWithData_H__
#define NET_MINECRAFT_WORLD_LEVEL_LEVELGEN_FEATURE__OreFeatureWithData_H__

// Like OreFeature but also sets data value (for stone variants)
...
class OreFeatureWithData: public Feature {
    int tile;
    int data;
    int count;

public:
	OreFeatureWithData(int tile, int data, int count) {
        this->tile = tile;
        this->data = data;
        this->count = count;
    }
...
#endif /*NET_MINECRAFT_WORLD_LEVEL_LEVELGEN_FEATURE__OreFeatureWithData_H__*/
