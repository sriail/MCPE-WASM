	...
	downfall(0.5f)
{
    ...
    _enemies.insert(_enemies.end(), MobSpawnerData(MobTypes::Slime, 10, 2, 4));
    _enemies.insert(_enemies.end(), MobSpawnerData(MobTypes::Enderman, 1, 1, 1));
...
Biome* Biome::setTemperatureAndDownfall(float temp, float down)
{
...
void Biome::initBiomes() {
	...
	seasonalForest	= (new Biome())->setColor(0x9BE023)->setName("Seasonal Forest")->setTemperatureAndDownfall(0.7f, 0.6f);
	forest			= (new ForestBiome())->setColor(0x056621)->setName("Forest")->setLeafColor(0x4EBA31)->setTemperatureAndDownfall(0.7f, 0.8f);
	savanna			= (new FlatBiome())->setColor(0xD9E023)->setName("Savanna")->setTemperatureAndDownfall(0.85f, 0.1f);
	shrubland		= (new Biome())->setColor(0xA1AD20)->setName("Shrubland")->setTemperatureAndDownfall(0.6f, 0.3f);
