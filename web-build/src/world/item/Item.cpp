...
void Item::initItems() {
	...
	// --- New items ---
	Item::greenEmerald = (new Item(151))->setIcon(10, 9)->setCategory(ItemCategory::Decorations)->setDescriptionId("greenEmerald");
	Item::enderPearl = (new Item(152))->setIcon(11, 9)->setCategory(ItemCategory::Tools)->setDescriptionId("enderPearl");
	Item::cocoaBeans = (new Item(153))->setIcon(14, 4)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cocoaBeans");
	Item::cookie = (new FoodItem(154, 2, false))->setIcon(12, 5)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cookie");
	Item::mutton_raw = (new FoodItem(155, 2, true))->setIcon(9, 8)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("muttonRaw");
	Item::mutton_cooked = (new FoodItem(156, 6, true))->setIcon(10, 8)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("muttonCooked");

	// Wood variant doors (flat inventory icon)
	Item::door_spruce = (new DoorItem(157, Material::wood))->setIcon(11, 10)->setCategory(ItemCategory::Structures)->setDescriptionId("doorSpruce");
	Item::door_birch = (new DoorItem(158, Material::wood))->setIcon(12, 10)->setCategory(ItemCategory::Structures)->setDescriptionId("doorBirch");
	Item::door_jungle = (new DoorItem(159, Material::wood))->setIcon(13, 10)->setCategory(ItemCategory::Structures)->setDescriptionId("doorJungle");

	// Wood variant signs (flat inventory icon)
	Item::sign_spruce = (new SignItem(160))->setIcon(10, 10)->setCategory(ItemCategory::Decorations)->setDescriptionId("signSpruce");
	Item::sign_birch = (new SignItem(161))->setIcon(10, 10)->setCategory(ItemCategory::Decorations)->setDescriptionId("signBirch");
	Item::sign_jungle = (new SignItem(162))->setIcon(10, 10)->setCategory(ItemCategory::Decorations)->setDescriptionId("signJungle");
