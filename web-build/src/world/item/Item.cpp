...
void Item::initItems() {
	...
	Item::cookie = (new FoodItem(111, 2, false))->setIcon(12, 5)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("cookie");
	Item::mutton_raw = (new FoodItem(112, 2, true))->setIcon(9, 8)->setCategory(ItemCategory::FoodArmor)->setDescriptionId("muttonRaw");
