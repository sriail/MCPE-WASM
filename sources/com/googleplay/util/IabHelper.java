...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        if (this.mContext != null && this.mContext.getPackageManager() != null && this.mContext.getPackageManager().queryIntentServices(serviceIntent, 0) != null && !this.mContext.getPackageManager().queryIntentServices(serviceIntent, 0).isEmpty()) {
    ...
    public boolean handleActivityResult(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x0006:
            ...
            r12.logError(r8)
            com.googleplay.util.IabResult r6 = new com.googleplay.util.IabResult
            r8 = -1002(0xfffffffffffffc16, float:NaN)
            java.lang.String r9 = "Null data in IAB result"
            r6.<init>(r8, r9)
            com.googleplay.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
        ...
        L_0x00e2:
            r2 = 0
            com.googleplay.util.Purchase r3 = new com.googleplay.util.Purchase     // Catch:{ JSONException -> 0x014b }
            ...
            boolean r8 = com.googleplay.util.Security.verifyPurchase(r8, r4, r0)     // Catch:{ JSONException -> 0x0206 }
            ...
            com.googleplay.util.IabResult r6 = new com.googleplay.util.IabResult     // Catch:{ JSONException -> 0x0206 }
            ...
            com.googleplay.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x0206 }
        ...
        L_0x0132:
            ...
            com.googleplay.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            com.googleplay.util.IabResult r9 = new com.googleplay.util.IabResult
            r10 = 0
        ...
        L_0x0206:
            ...
            goto L_0x014c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.googleplay.util.IabHelper.handleActivityResult(int, int, android.content.Intent):boolean");
    }
    ...
    public int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus) throws RemoteException, JSONException {
        ...
        while (i$.hasNext()) {
            ...
            querySkus.putStringArrayList(GET_SKU_DETAILS_ITEM_LIST, i$.next());
            ...
            while (i$2.hasNext()) {
                SkuDetails d = new SkuDetails(itemType, i$2.next());
