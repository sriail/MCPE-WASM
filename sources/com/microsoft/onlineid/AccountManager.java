...
public class AccountManager {
    ...
    public SsoRunnable getAccountRunnable(final Bundle state) {
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getSignInIntentRunnable(SignInOptions options, Bundle state) {
    ...
    public void getSignUpIntent(Bundle state) {
        getSignUpIntent((SignUpOptions) null, state);
    }
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getSignUpIntentRunnable(SignUpOptions options, Bundle state) {
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getAccountByIdRunnable(String cid, Bundle state) {
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getAllAccountsRunnable(final Bundle state) {
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getAccountPickerIntentRunnable(Iterable<String> cidExclusionList, Bundle state) {
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getSignOutIntentRunnable(UserAccount account, Bundle state) {
    ...
    public void getTicket(UserAccount account, ISecurityScope scope, Bundle state) {
        verifyCallback(this._accountCallback, IAccountCallback.class.getSimpleName());
    ...
    /* access modifiers changed from: protected */
    public SsoRunnable getTicketRunnable(UserAccount account, ISecurityScope scope, Bundle state) {
        final UserAccount userAccount = account;
        ...
        return new SsoRunnable(this._ticketCallback, state) {
            public void performRequest() throws AuthenticationException {
                try {
                    ...
                    if (ssoResponse.hasData()) {
                        AccountManager.this._ticketCallback.onTicketAcquired(ssoResponse.getData(), userAccount, bundle);
                    } else {
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultType == ActivityResultSender.ResultType.Ticket) {
        ...
        if (resultCode == 0) {
            ...
            try {
                ...
                failureCallback.onFailure(new InternalException((Throwable) e3), state);
            }
        }
        return true;
    }
