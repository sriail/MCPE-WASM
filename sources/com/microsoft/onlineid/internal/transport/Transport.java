...
public class Transport {
    ...
    public InputStream getResponseStream() throws NetworkException {
        try {
            ...
            throw new NetworkException((Throwable) io);
        }
    }
    ...
    public void appendCustomUserAgentString(String userAgentString) {
        this._customUserAgentString = mergeUserAgentStrings(this._customUserAgentString, userAgentString);
    }

    /* access modifiers changed from: package-private */
    public void setHttpsURLConnectionWrapper(HttpsURLConnectionWrapper httpsURLConnectionWrapper) {
