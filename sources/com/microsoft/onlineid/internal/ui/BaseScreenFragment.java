...
public class BaseScreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(resources.getId("baseScreenHeader"))).setText(arguments.getString(headerArgumentKey));
        ((TextView) view.findViewById(resources.getId("baseScreenBody"))).setText(arguments.getString(bodyArgumentKey));
        return view;
    }
    ...
    public static <T extends BaseScreenFragment> T buildWithBaseScreen(String header, String body, Class<T> genericClass) {
        ...
        try {
            T fragment = (BaseScreenFragment) genericClass.newInstance();
