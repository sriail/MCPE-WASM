...
public class BundledAssetVendor implements IWebPropertyProvider {
    ...
    public String buildLocalAssetPath(String url) {
    ...
    public WebResourceResponse getAsset(String url) {
        ...
        try {
            WebResourceResponse response = new WebResourceResponse(mimetype.toString(), HttpURLConnectionBuilder.DEFAULT_CHARSET, this._assetManager.open(localAssetPath));
