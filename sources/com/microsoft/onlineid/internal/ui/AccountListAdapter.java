...
public class AccountListAdapter extends AbstractListAdapter<AuthenticatorUserAccount> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = ((LayoutInflater) parent.getContext().getSystemService("layout_inflater")).inflate(this._resources.getLayout("account_picker_tile"), (ViewGroup) null);
        }
    ...
    public void setupBasicAccountViews(View inflatedView, AuthenticatorUserAccount account) {
        ...
        ((TextView) inflatedView.findViewById(this._textEmailResId)).setText(account.getUsername());
