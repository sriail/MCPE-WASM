...
public class SignatureVerifier {
    ...
    public boolean isTrusted(String packageName) {
        ...
        try {
            ...
            Set<String> hashWhitelist = this._config.getStringSet(ServerConfig.AndroidSsoCertificates);
            ...
            Logger.warning("Not trusting " + packageName + " because no matching hash was found in the whitelist.");
            Logger.warning("Hashes for " + packageName + " are: " + Arrays.toString(appHashes.toArray()));
            Logger.warning("Whitelist is: " + Arrays.toString(hashWhitelist.toArray()));
            return false;
