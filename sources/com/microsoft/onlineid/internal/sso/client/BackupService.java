...
public class BackupService extends IntentService {
    ...
    /* access modifiers changed from: protected */
    public void retrieveAndPushBackup() {
        Bundle backup;
    ...
    /* access modifiers changed from: protected */
    public void retrieveAndPushBackupIfNeeded() {
        if ((System.currentTimeMillis() - this._storage.readLastBackupPushedTime()) / 1000 >= ((long) this._config.getInt(ServerConfig.Int.MaxSecondsBetweenBackups))) {
            retrieveAndPushBackup();
        }
    }

    /* access modifiers changed from: protected */
    public Bundle retrieveBackup(SsoService ssoService) {
        try {
    ...
    /* access modifiers changed from: protected */
    public void storeBackup(SsoService ssoService, Bundle backup) {
        try {
