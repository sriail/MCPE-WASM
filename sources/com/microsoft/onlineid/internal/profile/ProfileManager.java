...
public class ProfileManager {
    ...
    protected static class JsonParser {
        ...
        public String parseDisplayName(JsonReader reader) throws IOException {
            try {
                reader.beginObject();
        ...
        /* access modifiers changed from: protected */
        public String readDisplayNameFromEntry(JsonReader reader) throws IOException {
            String key = null;
            String value = null;
            reader.beginObject();
            while (reader.hasNext()) {
        ...
        /* access modifiers changed from: protected */
        public void findName(JsonReader reader, String expectedName) throws IOException {
            while (reader.hasNext()) {
    ...
    /* renamed from: com.microsoft.onlineid.internal.profile.ProfileManager$1  reason: invalid class name */
