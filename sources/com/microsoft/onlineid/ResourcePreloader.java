...
public class ResourcePreloader {
    ...
    public static final Logger logger = Logger.getLogger("ResourcePreloader");
    ...
    private static Uri buildUri(Context context, String cobrandId) {
        return Uris.appendMarketQueryString(context.getApplicationContext(), Uri.parse(PROD_PRELOAD_URI).buildUpon().appendQueryParameter(AddAccountActivity.CobrandingIdLabel, cobrandId).build());
    }
}
