...
public abstract class AbstractStsResponse {
    ...
    public abstract void parse(XmlPullParser xmlPullParser) throws IOException, StsParseException;
    ...
    public void parse(InputStream stream) throws IOException, StsParseException {
        try {
            ...
            Logger.info((IRedactable) new RedactableResponse(String.format(Locale.US, "%s: %s", new Object[]{getClass().getSimpleName(), responseXml})));
