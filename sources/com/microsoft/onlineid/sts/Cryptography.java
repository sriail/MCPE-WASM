...
public class Cryptography {
    ...
    public static byte[] decryptWithAesCbcPcs5PaddingCipher(byte[] encryptedData, byte[] encryptionKey) throws IllegalBlockSizeException, BadPaddingException {
        return getInitializedDecryptionCipher(AesCbcPkcs5PaddingTransformation, new SecretKeySpec(encryptionKey, AesAlgorithm), new IvParameterSpec(encryptedData, 0, 16)).doFinal(encryptedData, 16, encryptedData.length - 16);
    }
