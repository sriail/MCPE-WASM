...
public class XmlSigner {
    ...
    public String computeSignatureForRequest(byte[] sessionKey, String signatureInput) {
    ...
    /* access modifiers changed from: package-private */
    public String computeSignatureImplementation(byte[] sessionKey, byte[] nonce, String signatureInput) {
        return Base64.encodeToString(Cryptography.getInitializedHmacSha256Digester(new SecretKeySpec(new SharedKeyGenerator(sessionKey).generateKey(SharedKeyGenerator.KeyPurpose.STSDigest, nonce), Cryptography.HmacSha256Algorithm)).doFinal(signatureInput.getBytes(Strings.Utf8Charset)), 2);
    }

    /* access modifiers changed from: package-private */
    public String buildSignedInfoTag() {
    ...
    /* access modifiers changed from: package-private */
    public String elementToCanonicalizedString(Element element) {
