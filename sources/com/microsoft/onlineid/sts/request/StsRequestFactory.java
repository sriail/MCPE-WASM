...
public class StsRequestFactory {
    ...
    public ServiceRequest createServiceRequest(AuthenticatorUserAccount userAccount, DeviceIdentity deviceIdentity, String packageName, ISecurityScope scope) {
        return createServiceRequest(userAccount, deviceIdentity, scope, packageName, (String) null);
    }

    /* access modifiers changed from: protected */
    public void initializeRequest(AbstractStsRequest<?> request) {
        ServerConfig config = getConfig();
        ServerConfig.Endpoint endpoint = request.getEndpoint();
