...
public abstract class AbstractStsRequest<ResponseType extends AbstractStsResponse> {
    ...
    public abstract ResponseType instantiateResponse();
    ...
    /* access modifiers changed from: protected */
    public ClockSkewManager getClockSkewManager() {
    ...
    public final Document createBlankDocument(String rootNamespace, String rootElementName) {
        ...
        try {
            return factory.newDocumentBuilder().getDOMImplementation().createDocument(rootNamespace, rootElementName, (DocumentType) null);
    ...
    public ResponseType send() throws NetworkException, InvalidResponseException {
        ...
        try {
            ...
            if (Settings.isDebugBuild()) {
                ...
                Logger.info((IRedactable) new RedactableXml(String.format(Locale.US, "%s: %s", new Object[]{getClass().getSimpleName(), request}), new String[0]));
    ...
    /* access modifiers changed from: protected */
    public String getAnalyticsRequestType() {
        return "(none)";
    }
}
