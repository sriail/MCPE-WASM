...
public abstract class AbstractSoapRequest<ResponseType extends AbstractSoapResponse> extends AbstractStsRequest<ResponseType> {
    ...
    public abstract void buildSecurityNode(Element element);

    /* access modifiers changed from: protected */
    public abstract void buildSoapBody(Element element);
    ...
    /* access modifiers changed from: protected */
    public void buildSoapHeader(Element header) {
    ...
    /* access modifiers changed from: protected */
    public void buildAuthInfo(Element authInfo) {
    ...
    /* access modifiers changed from: protected */
    public final void appendTimestamp(Element parent) {
    ...
    /* access modifiers changed from: protected */
    public final void appendDeviceDAToken(Element parent, DAToken deviceDAToken) {
