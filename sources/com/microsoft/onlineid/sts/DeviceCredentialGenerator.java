...
public class DeviceCredentialGenerator {
    ...
    public DeviceCredentials generate() {
        return new DeviceCredentials(LogicalDevicePrefix + generateRandomString(LegalUsernameCharacters, 20 - LogicalDevicePrefix.length()), generateRandomString(LegalPasswordCharacters, 16));
    }
