...
public class XboxAppDeepLinker {
    ...
    private static Intent getXboxAppLaunchIntent(Context context) {
        ...
        return betaAppInstalled ? context.getPackageManager().getLaunchIntentForPackage("com.microsoft.xboxone.smartglass.beta") : context.getPackageManager().getLaunchIntentForPackage("com.microsoft.xboxone.smartglass");
    }
