...
public final class JsonHelper {
    ...
    public static void writeListString(Writer writer, List<String> list) throws IOException {
        ...
        if (iterator.hasNext()) {
            writer.write("[");
            writer.write(convert(iterator.next()));
            while (iterator.hasNext()) {
                writer.write(",");
                writer.write(convert(iterator.next()));
            }
    ...
    private static <T> void writeItem(Writer writer, T item) throws IOException {
        if (item == null) {
            ...
            writer.write(convert((String) (String) item));
        } else if (item instanceof Double) {
            writer.write(convert((Double) (Double) item));
        } else if (item instanceof Integer) {
            writer.write(convert((Integer) (Integer) item));
        } else if (item instanceof Long) {
            writer.write(convert((Long) (Long) item));
