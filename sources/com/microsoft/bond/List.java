...
public class List<T extends BondSerializable, U extends BondSerializable> implements BondSerializable, BondMirror {
    ...
    public final void setValue(LinkedList<T> value2) {
        this.value = value2;
    }
    ...
    public boolean memberwiseCompareQuick(com.microsoft.bond.List<T, U> r6) {
        /*
            r5 = this;
            r2 = 1
            r3 = 0
            ...
            java.util.LinkedList<T> r1 = r5.value
            if (r1 != 0) goto L_0x001a
            r1 = r2
        L_0x000a:
            java.util.LinkedList<T> r4 = r6.value
        ...
        L_0x002e:
            ...
            goto L_0x0019
        */
        throw new UnsupportedOperationException("Method not decompiled: com.microsoft.bond.List.memberwiseCompareQuick(com.microsoft.bond.List):boolean");
    }

    /* access modifiers changed from: protected */
    public boolean memberwiseCompareDeep(List<T, U> that) {
