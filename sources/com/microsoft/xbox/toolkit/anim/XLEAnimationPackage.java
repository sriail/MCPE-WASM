...
public class XLEAnimationPackage {
    ...
    private class XLEAnimationEntry {
        ...
        public XLEAnimationEntry(XLEAnimation animation2) {
            this.animation = animation2;
            animation2.setOnAnimationEnd(new Runnable(XLEAnimationPackage.this) {
                public void run() {
    ...
    public XLEAnimationPackage add(XLEAnimationPackage animationPackage) {
        if (animationPackage != null) {
            Iterator i$ = animationPackage.animations.iterator();
            while (i$.hasNext()) {
                add(((XLEAnimationEntry) i$.next()).animation);
            }
        }
        return this;
    }
