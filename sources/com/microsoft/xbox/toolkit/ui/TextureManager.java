            ...
            while (true) {
                ...
                if (request.stream != null) {
                    ...
                    try {
                        ...
                        BitmapFactory.Options scaleoptions = TextureManager.this.computeInSampleSizeOptions(request.key.bindingOption.width, request.key.bindingOption.height, options);
                ...
                synchronized (TextureManager.this.listLock) {
                    if (bitmap != null) {
                        ...
                        TextureManager.this.timeToRetryCache.remove(request.key);
                        ...
                        RetryEntry retryEntry = (RetryEntry) TextureManager.this.timeToRetryCache.get(request.key);
                        if (retryEntry != null) {
                            retryEntry.startNext();
                        } else {
                            TextureManager.this.timeToRetryCache.put(request.key, new RetryEntry());
                        }
                    }
