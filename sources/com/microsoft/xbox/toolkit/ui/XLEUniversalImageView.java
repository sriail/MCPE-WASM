...
public class XLEUniversalImageView extends XLEImageView {
    ...
    public XLEUniversalImageView(Context context, Params params) {
        super(context);
        this.listener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                int height = bottom - top;
                if (!(right - left == oldRight - oldLeft && height == oldBottom - oldTop) && XLEUniversalImageView.this.arg.hasText()) {
    ...
    public void setAdjustViewBounds(boolean adjustViewBounds2) {
        this.adjustViewBounds = adjustViewBounds2;
    ...
    public static class Params {
        ...
        public Params cloneWithText(String text) {
            return new Params(new XLETextArg(text, this.argText.getParams()), (XLEURIArg) null, this.hasSrc);
        }
        ...
        public Params cloneWithUri(URI uri) {
            return cloneWithUri(uri, this.argUri == null ? -1 : this.argUri.getLoadingResourceId(), this.argUri == null ? -1 : this.argUri.getErrorResourceId());
        }

        public Params cloneWithSrc(boolean hasSrc2) {
            return new Params(new XLETextArg(this.argText.getParams()), (XLEURIArg) null, hasSrc2);
        }

        public Params cloneEmpty() {
            return new Params(new XLETextArg(this.argText.getParams()), (XLEURIArg) null, false);
        }
