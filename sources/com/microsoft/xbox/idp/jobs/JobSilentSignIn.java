...
public class JobSilentSignIn extends MSAJob {
    ...
    public JobSilentSignIn(Context context, CharSequence activityTitle2, MSAJob.Callbacks callbacks, String scope2, String policy2, String cid2) {
    ...
    public JobSilentSignIn start() {
        this.accountManager.getAccountById(this.cid, (Bundle) null);
