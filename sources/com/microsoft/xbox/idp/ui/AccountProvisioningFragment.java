...
public class AccountProvisioningFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    static final /* synthetic */ boolean $assertionsDisabled = (!AccountProvisioningFragment.class.desiredAssertionStatus());
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Profile.GamerpicChoiceList>> gamerpicChoiceListCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Profile.GamerpicChoiceList>>() {
        ...
        public void onLoadFinished(Loader<ObjectLoader.Result<Profile.GamerpicChoiceList>> loader, ObjectLoader.Result<Profile.GamerpicChoiceList> result) {
            ...
            if (!gamerPicList.isEmpty()) {
                String gamerPicUrl = String.format("http://dlassets.xboxlive.com/public/content/ppl/gamerpics/%s-xl.png", new Object[]{gamerPicList.get(new Random().nextInt(gamerPicList.size())).id});
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Profile.GamerpicUpdateResponse>> gamerpicUpdateCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Profile.GamerpicUpdateResponse>>() {
        public Loader<ObjectLoader.Result<Profile.GamerpicUpdateResponse>> onCreateLoader(int id, Bundle args) {
            ...
            httpCall.setRequestBody(new GsonBuilder().create().toJson((Object) req, (Type) Profile.GamerpicChangeRequest.class));
            return new ObjectLoader(AccountProvisioningFragment.this.getActivity(), (ObjectLoader.Cache) null, args.get(ErrorHelper.KEY_RESULT_KEY), Profile.GamerpicUpdateResponse.class, Profile.registerAdapters(new GsonBuilder()).create(), httpCall);
        }
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Privacy.Settings>> getPrivacySettingsCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Privacy.Settings>>() {
        public Loader<ObjectLoader.Result<Privacy.Settings>> onCreateLoader(int id, Bundle args) {
            ...
            return new ObjectLoader(AccountProvisioningFragment.this.getActivity(), CacheUtil.getObjectLoaderCache(), args.get(ErrorHelper.KEY_RESULT_KEY), Privacy.Settings.class, Privacy.registerAdapters(new GsonBuilder()).create(), HttpUtil.appendCommonParameters(new HttpCall("GET", EndpointsFactory.get().privacy(), "/users/me/privacy/settings"), "4"));
        }
        ...
        public void onLoadFinished(Loader<ObjectLoader.Result<Privacy.Settings>> loader, ObjectLoader.Result<Privacy.Settings> result) {
            ...
            if (result.hasData()) {
                ...
                } else if (ps.isSettingSet(Privacy.Key.ShareIdentity) || ps.isSettingSet(Privacy.Key.ShareIdentityTransitively)) {
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Void>> setPrivacySettingsCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Void>>() {
        public Loader<ObjectLoader.Result<Void>> onCreateLoader(int id, Bundle args) {
            ...
            httpCall.setRequestBody(Privacy.registerAdapters(new GsonBuilder()).create().toJson((Object) ps, (Type) Privacy.Settings.class));
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<UserAccount>> userProfileCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<UserAccount>>() {
            ...
            switch (loader.getId()) {
                case 1:
                    ...
                    if (result.hasData()) {
                        ...
                        UserAccount unused = AccountProvisioningFragment.this.userAccount = result.getData();
                ...
                case 2:
                    ...
                    if (result.hasData()) {
                        Log.e(AccountProvisioningFragment.TAG, "Got UserAccount");
                        UserAccount unused2 = AccountProvisioningFragment.this.userAccount = result.getData();
    ...
    private final LoaderManager.LoaderCallbacks<XTokenLoader.Result> xtokenCallbacks = new LoaderManager.LoaderCallbacks<XTokenLoader.Result>() {
        ...
        public void onLoadFinished(Loader<XTokenLoader.Result> loader, XTokenLoader.Result result) {
            ...
            if (result.hasData()) {
                XTokenLoader.Data unused = AccountProvisioningFragment.this.xtokenData = (XTokenLoader.Data) result.getData();
    ...
    /* access modifiers changed from: private */
    public XTokenLoader.Data xtokenData;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args == null) {
            ...
            this.callbacks.onCloseWithStatus(Status.PROVIDER_ERROR, (AccountProvisioningResult) null);
