...
public class FinishSignInFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    static final /* synthetic */ boolean $assertionsDisabled = (!FinishSignInFragment.class.desiredAssertionStatus());
    ...
    private final LoaderManager.LoaderCallbacks<FinishSignInLoader.Result> finishSignInCallbacks = new LoaderManager.LoaderCallbacks<FinishSignInLoader.Result>() {
