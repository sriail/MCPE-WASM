...
public class SignUpFragment extends BaseFragment implements View.OnClickListener, ErrorHelper.ActivityContext {
    static final /* synthetic */ boolean $assertionsDisabled = (!SignUpFragment.class.desiredAssertionStatus());
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<GamerTag.Response>> gamerTagClaimCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<GamerTag.Response>>() {
        public Loader<ObjectLoader.Result<GamerTag.Response>> onCreateLoader(int id, Bundle args) {
            ...
            httpCall.setRequestBody(new Gson().toJson((Object) req, (Type) GamerTag.Request.class));
    ...
    private final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Void>> gamerTagReservationCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Void>>() {
        public Loader<ObjectLoader.Result<Void>> onCreateLoader(int id, Bundle args) {
            ...
            httpCall.setRequestBody(new Gson().toJson((Object) new GamerTag.ReservationRequest(SignUpFragment.this.editTextGamerTag.getText().toString(), SignUpFragment.this.provisioningResult.getXuid()), (Type) GamerTag.ReservationRequest.class));
        ...
        public void onLoadFinished(Loader<ObjectLoader.Result<Void>> loader, ObjectLoader.Result<Void> result) {
            ...
            if (!result.hasError()) {
                ...
                SignUpFragment.this.resetGamerTagState(SignUpFragment.this.editTextGamerTag.getText());
                SignUpFragment.this.getLoaderManager().restartLoader(3, (Bundle) null, SignUpFragment.this.suggestionsCallbacks);
            } else {
    ...
    private final AdapterView.OnItemClickListener onSuggestionClickListener = new AdapterView.OnItemClickListener() {
    ...
    public State state;
    /* access modifiers changed from: private */
    public final LoaderManager.LoaderCallbacks<ObjectLoader.Result<Suggestions.Response>> suggestionsCallbacks = new LoaderManager.LoaderCallbacks<ObjectLoader.Result<Suggestions.Response>>() {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.editTextGamerTag.setOnFocusChangeListener(new View.OnFocusChangeListener() {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.xbid_enter_gamertag_comment || id == R.id.xbid_search) {
            ...
            getLoaderManager().restartLoader(2, (Bundle) null, this.gamerTagReservationCallbacks);
            ...
            if (this.gamerTagState == GamerTagState.INITIAL) {
                ...
                getLoaderManager().restartLoader(1, (Bundle) null, this.gamerTagClaimCallbacks);
            }
    ...
    public void setGamerTagState(GamerTagState newState) {
        ...
        if (newState == GamerTagState.UNAVAILABLE_WITH_SUGGESTIONS && this.gamerTagState != newState) {
        ...
        } else if (newState != GamerTagState.UNAVAILABLE_WITH_SUGGESTIONS && this.gamerTagState == GamerTagState.UNAVAILABLE_WITH_SUGGESTIONS) {
            this.suggestionsListAdapter.clear();
            this.suggestionsListAdapter.notifyDataSetChanged();
        }
