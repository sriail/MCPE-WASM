...
public class XBLoginFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    static final /* synthetic */ boolean $assertionsDisabled = (!XBLoginFragment.class.desiredAssertionStatus());
    ...
    /* access modifiers changed from: private */
    public State state;
    private final LoaderManager.LoaderCallbacks<XBLoginLoader.Result> xbLoginCallbacks = new LoaderManager.LoaderCallbacks<XBLoginLoader.Result>() {
        ...
        public void onLoadFinished(Loader<XBLoginLoader.Result> loader, XBLoginLoader.Result result) {
            ...
            if (result.hasData()) {
                XBLoginLoader.Data data = (XBLoginLoader.Data) result.getData();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args == null) {
            ...
            this.callbacks.onComplete(Status.ERROR, (AuthFlowResult) null, false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        this.callbacks.onComplete(Status.PROVIDER_ERROR, (AuthFlowResult) null, false);
    }
