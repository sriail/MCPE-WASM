...
public class StartSignInFragment extends BaseFragment implements ErrorHelper.ActivityContext {
    static final /* synthetic */ boolean $assertionsDisabled = (!StartSignInFragment.class.desiredAssertionStatus());
    ...
    private final LoaderManager.LoaderCallbacks<StartSignInLoader.Result> startSignInCallbacks = new LoaderManager.LoaderCallbacks<StartSignInLoader.Result>() {
