...
public class MSAFragment extends BaseFragment implements MSAJob.Callbacks {
    static final /* synthetic */ boolean $assertionsDisabled = (!MSAFragment.class.desiredAssertionStatus());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            this.callbacks.onComplete(Status.ERROR, (String) null, (Ticket) null);
        } else {
    ...
    public void onFailure(MSAJob job, Exception e) {
        ...
        this.callbacks.onComplete(e instanceof NetworkException ? Status.PROVIDER_ERROR : Status.ERROR, (String) null, (Ticket) null);
    }
