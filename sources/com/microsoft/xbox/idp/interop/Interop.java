...
public class Interop {
    ...
    private static final DelegatedAuthJob.Callbacks brokeredSignInCallbacks = new DelegatedAuthJob.Callbacks() {
    ...
    public static void LogTelemetrySignIn(String api, String state) {
        ...
        UTCPageAction.track(name, name, new UTCAdditionalInfoModel());
    }
    ...
    public static void InitCLL(Context context, String iKey) {
        if (s_cll == null) {
            ...
            CLLCallback callback = new CLLCallback(context, (String) null);
            ...
            switch (purpose) {
                case OPPORTUNISTIC_SIGN_IN:
                    ...
                    if (TextUtils.isEmpty(cid)) {
                        ...
                        new JobSilentSignIn(context, (CharSequence) null, silentSignInCallbacks, isProd ? PROD_SCOPE : DNET_SCOPE, POLICY, cid).start();
                        return;
                    }
                case SIGN_OUT:
    ...
    public static void InvokeAuthFlow(long userPtr, Activity activity, boolean isProd) {
        ...
        AuthFlowActivity.setStaticCallbacks(new AuthFlowActivity.StaticCallbacks() {
            public void onAuthFlowFinished(long userPtr, AuthFlowScreenStatus authStatus, String cid) {
                AuthFlowActivity.setStaticCallbacks((AuthFlowActivity.StaticCallbacks) null);
