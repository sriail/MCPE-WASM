...
class SessionLogger {
    ...
    public static void logActivateApp(Activity activity, SourceApplicationInfo sourceApplicationInfo, String appId) {
        ...
        AppEventsLogger.newLogger((Context) activity, appId).logEvent(AppEventsConstants.EVENT_NAME_ACTIVATED_APP, eventParams);
    }
    ...
    public static void logDeactivateApp(Activity activity, SessionInfo sessionInfo, String appId) {
        ...
        AppEventsLogger.newLogger((Context) activity, appId).logEvent(AppEventsConstants.EVENT_NAME_DEACTIVATED_APP, (double) (sessionLength.longValue() / 1000), eventParams);
    }
