...
public class AppLinkData {
    ...
    private static AppLinkData createFromJson(String jsonString) {
        ...
        try {
            ...
            if (appLinkArgsJson.getJSONObject("bridge_args").getString(BRIDGE_ARGS_METHOD_KEY).equals("applink") && version.equals(XboxLiveEnvironment.USER_PROFILE_CONTRACT_VERSION)) {
                AppLinkData appLinkData = new AppLinkData();
