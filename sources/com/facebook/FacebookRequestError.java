...
public final class FacebookRequestError implements Parcelable {
    ...
    private FacebookRequestError(int requestStatusCode2, int errorCode2, int subErrorCode2, String errorType2, String errorMessage2, String errorUserTitle2, String errorUserMessage2, boolean errorIsTransient, JSONObject requestResultBody2, JSONObject requestResult2, Object batchRequestResult2, HttpURLConnection connection2, FacebookException exception2) {
        ...
        this.category = isLocalException ? Category.OTHER : errorClassification.classify(errorCode2, subErrorCode2, errorIsTransient);
        ...
        try {
            if (singleResult.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.contains(responseCode)) {
                    return new FacebookRequestError(responseCode, -1, -1, (String) null, (String) null, (String) null, (String) null, false, singleResult.has(BODY_KEY) ? (JSONObject) Utility.getStringPropertyAsJSON(singleResult, BODY_KEY, GraphResponse.NON_JSON_RESPONSE_PROPERTY) : null, singleResult, batchResult, connection2, (FacebookException) null);
                }
            }
