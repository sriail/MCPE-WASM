...
public class ProductDataResponse {
    ...
    public ProductDataResponse(ProductDataResponseBuilder productDataResponseBuilder) {
        d.a((Object) productDataResponseBuilder.getRequestId(), REQUEST_ID);
        d.a((Object) productDataResponseBuilder.getRequestStatus(), REQUEST_STATUS);
        ...
        if (RequestStatus.SUCCESSFUL == productDataResponseBuilder.getRequestStatus()) {
            d.a((Object) productDataResponseBuilder.getProductData(), PRODUCT_DATA);
        }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        if (this.productData != null) {
            for (String next : this.productData.keySet()) {
