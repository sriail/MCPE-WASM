...
class zzb {
    ...
    private Notification zzB(Bundle bundle) {
        String zzf = zzf(bundle, "gcm.n.title");
        String zzf2 = zzf(bundle, "gcm.n.body");
        int zzdW = zzdW(zze(bundle, "gcm.n.icon"));
        String zze = zze(bundle, "gcm.n.color");
        ...
        NotificationCompat.Builder smallIcon = new NotificationCompat.Builder(this.mContext).setAutoCancel(true).setSmallIcon(zzdW);
