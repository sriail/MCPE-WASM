...
public class MetricsManager {
    ...
    public static void register(Application application, String appIdentifier) {
        register(application, appIdentifier, (Sender) null, (Persistence) null, (Channel) null);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0047, code lost:
        net.hockeyapp.android.PrivateEventManager.addEventListener(new net.hockeyapp.android.metrics.MetricsManager.AnonymousClass1());
     */
    ...
    protected static void register(android.app.Application r9, java.lang.String r10, net.hockeyapp.android.metrics.Sender r11, net.hockeyapp.android.metrics.Persistence r12, net.hockeyapp.android.metrics.Channel r13) {
        /*
            r7 = 0
            net.hockeyapp.android.metrics.MetricsManager r0 = instance
            if (r0 != 0) goto L_0x004f
            java.lang.Object r8 = LOCK
            monitor-enter(r8)
            net.hockeyapp.android.metrics.MetricsManager r6 = instance     // Catch:{ all -> 0x0052 }
            if (r6 != 0) goto L_0x0058
            android.content.Context r1 = r9.getApplicationContext()     // Catch:{ all -> 0x0055 }
            net.hockeyapp.android.Constants.loadFromContext(r1)     // Catch:{ all -> 0x0055 }
            net.hockeyapp.android.metrics.MetricsManager r0 = new net.hockeyapp.android.metrics.MetricsManager     // Catch:{ all -> 0x0055 }
            android.content.Context r1 = r9.getApplicationContext()     // Catch:{ all -> 0x0055 }
            net.hockeyapp.android.metrics.TelemetryContext r2 = new net.hockeyapp.android.metrics.TelemetryContext     // Catch:{ all -> 0x0055 }
            android.content.Context r3 = r9.getApplicationContext()     // Catch:{ all -> 0x0055 }
            r2.<init>(r3, r10)     // Catch:{ all -> 0x0055 }
            r3 = r11
            r4 = r12
            r5 = r13
            r0.<init>(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x0055 }
            java.lang.ref.WeakReference r1 = new java.lang.ref.WeakReference     // Catch:{ all -> 0x0052 }
            r1.<init>(r9)     // Catch:{ all -> 0x0052 }
            sWeakApplication = r1     // Catch:{ all -> 0x0052 }
        L_0x002f:
            boolean r1 = net.hockeyapp.android.utils.Util.sessionTrackingSupported()     // Catch:{ all -> 0x0052 }
            if (r1 != 0) goto L_0x0050
            r1 = 1
        L_0x0036:
            r0.mSessionTrackingDisabled = r1     // Catch:{ all -> 0x0052 }
            instance = r0     // Catch:{ all -> 0x0052 }
            boolean r1 = r0.mSessionTrackingDisabled     // Catch:{ all -> 0x0052 }
            if (r1 != 0) goto L_0x0046
            r1 = 0
            java.lang.Boolean r1 = java.lang.Boolean.valueOf(r1)     // Catch:{ all -> 0x0052 }
            setSessionTrackingDisabled(r1)     // Catch:{ all -> 0x0052 }
        L_0x0046:
            monitor-exit(r8)     // Catch:{ all -> 0x0052 }
            net.hockeyapp.android.metrics.MetricsManager$1 r1 = new net.hockeyapp.android.metrics.MetricsManager$1
            r1.<init>()
    ...
    private void trackSessionState(final SessionState sessionState) {
        try {
            ...
            HockeyLog.error("Could not track session state. Executor rejected async task.", (Throwable) e);
        }
    }
    ...
    public static void trackEvent(String eventName) {
        trackEvent(eventName, (Map<String, String>) null);
    }

    public static void trackEvent(String eventName, Map<String, String> properties) {
        trackEvent(eventName, properties, (Map<String, Double>) null);
    }
        ...
        if (!TextUtils.isEmpty(eventName)) {
            if (instance == null) {
                ...
                try {
                    ...
                    HockeyLog.error("Could not track custom event. Executor rejected async task.", (Throwable) e);
                }
            }
        }
    }
