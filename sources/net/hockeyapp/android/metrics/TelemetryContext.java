...
class TelemetryContext {
    ...
    /* access modifiers changed from: protected */
    public void configSessionContext(String sessionId) {
    ...
    /* access modifiers changed from: protected */
    public void configApplicationContext() {
        String version;
        ...
        try {
            ...
            version = String.format("%s (%S)", new Object[]{info.versionName, Integer.toString(info.versionCode)});
        } catch (PackageManager.NameNotFoundException e) {
            HockeyLog.debug(TAG, "Could not get application context");
        } finally {
            setAppVersion(version);
        }
        setSdkVersion("android:" + "4.1.1");
    }

    /* access modifiers changed from: protected */
    public void configUserId() {
    ...
    /* access modifiers changed from: protected */
    public void configDeviceContext() {
    ...
    /* access modifiers changed from: protected */
    public void configInternalContext() {
        setSdkVersion("android:" + "4.1.1");
    }
