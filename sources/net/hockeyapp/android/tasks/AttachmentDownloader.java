...
public class AttachmentDownloader {
    ...
    /* access modifiers changed from: private */
    public Queue<DownloadJob> queue;
        ...
        if (!this.downloadRunning && (downloadJob = this.queue.peek()) != null) {
            DownloadTask downloadTask = new DownloadTask(downloadJob, new Handler() {
                public void handleMessage(Message msg) {
                    ...
                    boolean unused = AttachmentDownloader.this.downloadRunning = false;
                    AttachmentDownloader.this.downloadNext();
                }
            });
    ...
    private static class DownloadJob {
        ...
        private DownloadJob(FeedbackAttachment feedbackAttachment2, AttachmentView attachmentView2) {
            this.feedbackAttachment = feedbackAttachment2;
    ...
    private static class DownloadTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        public DownloadTask(DownloadJob downloadJob2, Handler handler2) {
