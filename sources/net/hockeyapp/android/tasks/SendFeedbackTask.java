...
public class SendFeedbackTask extends ConnectionTask<Void, Void, HashMap<String, String>> {
    ...
    private HashMap<String, String> doPostPut() {
        ...
        try {
            ...
            HttpURLConnection urlConnection2 = new HttpURLConnectionBuilder(this.mUrlString).setRequestMethod(this.mToken != null ? "PUT" : "POST").writeFormFields(parameters).build();
            urlConnection2.connect();
            result.put("status", String.valueOf(urlConnection2.getResponseCode()));
            result.put("response", getStringFromConnection(urlConnection2));
    ...
    private HashMap<String, String> doPostPutWithAttachments() {
        ...
        try {
            ...
            HttpURLConnection urlConnection2 = new HttpURLConnectionBuilder(this.mUrlString).setRequestMethod(this.mToken != null ? "PUT" : "POST").writeMultipartData(parameters, this.mContext, this.mAttachmentUris).build();
            urlConnection2.connect();
            result.put("status", String.valueOf(urlConnection2.getResponseCode()));
            result.put("response", getStringFromConnection(urlConnection2));
            if (urlConnection2 != null) {
