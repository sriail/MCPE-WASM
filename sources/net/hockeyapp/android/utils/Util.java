...
public class Util {
    ...
    public static String getFormString(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        for (String key : params.keySet()) {
            String key2 = URLEncoder.encode(key, HttpURLConnectionBuilder.DEFAULT_CHARSET);
            protoList.add(key2 + "=" + URLEncoder.encode(params.get(key), HttpURLConnectionBuilder.DEFAULT_CHARSET));
        }
    ...
    public static boolean isConnectedToNetwork(Context context) {
        ...
        if (connectivityManager == null || (activeNetwork = connectivityManager.getActiveNetworkInfo()) == null || !activeNetwork.isConnected()) {
            return false;
        }
        return true;
    }
