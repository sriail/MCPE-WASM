...
public class FeedbackActivity extends Activity implements View.OnClickListener {
    ...
    /* access modifiers changed from: private */
    public ArrayList<FeedbackMessage> mFeedbackMessages;
    private ScrollView mFeedbackScrollview;
    private boolean mFeedbackViewInitialized;
    /* access modifiers changed from: private */
    public boolean mInSendFeedback;
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            ...
            Iterator<Uri> it = savedInstanceState.getParcelableArrayList("attachments").iterator();
            while (it.hasNext()) {
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.button_send) {
            ...
            sendFetchFeedback(this.mUrl, (String) null, (String) null, (String) null, (String) null, (List<Uri>) null, PrefsUtil.getInstance().getFeedbackTokenFromPrefs(this.mContext), this.mFeedbackHandler, true);
        }
    }
    ...
    public Dialog onCreateDialog(int id) {
        switch (id) {
            case 0:
                return new AlertDialog.Builder(this).setMessage(getString(R.string.hockeyapp_dialog_error_message)).setCancelable(false).setTitle(getString(R.string.hockeyapp_dialog_error_title)).setIcon(17301543).setPositiveButton(getString(R.string.hockeyapp_dialog_positive_button), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ErrorObject unused = FeedbackActivity.this.mError = null;
                        dialog.cancel();
                    }
                }).create();
            default:
    ...
    /* access modifiers changed from: protected */
    public void configureFeedbackView(boolean haveToken) {
    ...
    /* access modifiers changed from: protected */
    public void onSendFeedbackResult(boolean success) {
    }
    ...
    private void configureAppropriateView() {
        ...
        sendFetchFeedback(this.mUrl, (String) null, (String) null, (String) null, (String) null, (List<Uri>) null, this.mToken, this.mFeedbackHandler, true);
    }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                if (feedbackResponse != null && feedbackResponse.getFeedback() != null && feedbackResponse.getFeedback().getMessages() != null && feedbackResponse.getFeedback().getMessages().size() > 0) {
                    ArrayList unused = FeedbackActivity.this.mFeedbackMessages = feedbackResponse.getFeedback().getMessages();
                    ...
                    if (FeedbackActivity.this.mMessagesAdapter == null) {
                        MessagesAdapter unused2 = FeedbackActivity.this.mMessagesAdapter = new MessagesAdapter(FeedbackActivity.this.mContext, FeedbackActivity.this.mFeedbackMessages);
                    } else {
    ...
    private static class FeedbackHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (feedbackActivity != null) {
                ...
                ErrorObject unused = feedbackActivity.mError = error;
                if (!success) {
    ...
    private static class ParseFeedbackHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            final FeedbackActivity feedbackActivity = (FeedbackActivity) this.mWeakFeedbackActivity.get();
            if (feedbackActivity != null) {
                ErrorObject unused = feedbackActivity.mError = new ErrorObject();
                if (!(msg == null || msg.getData() == null || (feedbackResponse = (FeedbackResponse) msg.getData().getSerializable(ParseFeedbackTask.BUNDLE_PARSE_FEEDBACK_RESPONSE)) == null)) {
                    if (feedbackResponse.getStatus().equalsIgnoreCase("success")) {
                        ...
                        if (feedbackResponse.getToken() != null) {
                            ...
                            boolean unused2 = feedbackActivity.mInSendFeedback = false;
                        }
                    } else {
                        success = false;
                    }
