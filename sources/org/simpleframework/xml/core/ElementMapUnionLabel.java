...
class ElementMapUnionLabel extends TemplateLabel {
    ...
    public ElementMapUnionLabel(Contact contact2, ElementMapUnion union, ElementMap element, Format format) throws Exception {
        this.extractor = new GroupExtractor(contact2, union, format);
        this.label = new ElementMapLabel(contact2, element, format);
    ...
    public Converter getConverter(Context context) throws Exception {
        ...
        if (type != null) {
            return new CompositeMapUnion(context, this.extractor, path2, type);
        }
