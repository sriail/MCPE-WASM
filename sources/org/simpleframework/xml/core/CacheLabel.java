...
class CacheLabel implements Label {
    ...
    public Type getType(Class type2) throws Exception {
        return this.label.getType(type2);
    }

    public Label getLabel(Class type2) throws Exception {
        return this.label.getLabel(type2);
    }
